public class SmartDevice {
    ...
    public static void main(String[] args) {
        ...
        SmartDevice device1 = new SmartDevice("Thermostat", "Living Room", false, 5.0);
        SmartDevice device2 = new SmartDevice("LightBulb", "Bedroom", true, 1.2);
        // Test method chaining using returned this
        device1.setOnline(true).connectToDevice("Alexa").rename("Main Thermostat");
        device2.connectToDevice("Smart Switch").setOnline(false);
